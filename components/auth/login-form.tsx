      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            className="border-gray-600 data-[state=checked]:bg-primary-blue"
          />
          <Label htmlFor="remember" className="text-sm text-gray-300">
            Remember me
          </Label>
        </div>
        <Link href="/forgot-password" className="text-sm text-primary-blue hover:text-blue-400">
          Forgot password?
        </Link>
      </div>
      ...
      <div className="text-center">
        <p className="text-sm text-gray-400">
          ...
          <button
            ...
            className="text-primary-blue hover:text-blue-400 font-medium"
          >
            Sign up
          </button>
        </p>
